...
class Order extends MY_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('kasir/order_m');
    }

    public function index()
    {
        $this->template->display('kasir/order/view');
    }
    ...
    public function data_list()
    {
        ...
        foreach ($List as $r) {
            ...
            $link  = site_url('kasir/order/editdata/' . $r->order_id);
    ...
    public function adddata()
    {
        ...
        redirect(site_url('kasir/order/editdata/' . $order_id . '/' . $NoOrder));
    }

    public function editdata($order_id)
    {
        $data['detail'] = $this->db->get_where('v_order', array('order_id' => $order_id))->row();
        $this->template->display('kasir/order/edit', $data);
    }
