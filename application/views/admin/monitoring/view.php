            ...
            <div class="col-md-12">
                <div class="portlet box blue-madison">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a onclick="Refresh()">
                                <button type="button" class="btn btn-primary btn-xs"><i class="fa fa-refresh"></i>
                                    Refresh</button>
                            </a>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('#tableData').DataTable({
            "processing": true, // ✅ Harus true agar parameter dikirim
            "serverSide": true, // ✅ Wajib kalau ambil data dari controller
            "paging": true, // ✅ Aktifkan paging agar 'start' dikirim
            "info": true, // ✅ Bisa lihat jumlah data
            "searching": true, // ✅ Supaya search[value] dikirim
            "order": [],
            "ajax": {
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <select class="form-control" name="lstStatus" id="lstStatus">
                                ...
                                <option value="3">menu sama</option>
                            </select>
                        </div>
                    </div>
                </div>
