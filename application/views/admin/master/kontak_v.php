                                    ...
                                    <div class="col-md-9">
                                        <div class="input-icon right">
                                            ...
                                            <input type="text" class="form-control" name="name"
                                                value="<?= $detail->contact_name; ?>" autocomplete="off" autofocus />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-icon right">
                                            ...
                                            <input type="text" class="form-control" name="address"
                                                value="<?= $detail->contact_address; ?>" autocomplete="off" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-icon right">
                                            ...
                                            <input type="text" class="form-control" name="phone"
                                                value="<?= $detail->contact_phone; ?>" autocomplete="off" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-icon right">
                                            ...
                                            <input type="text" class="form-control" name="email"
                                                value="<?= $detail->contact_email; ?>" autocomplete="off" />
                                        </div>
                                    </div>
                                </div>
                                <!-- <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-icon right">
                                            ...
                                            <input type="text" class="form-control" name="web"
                                                value="<?= $detail->contact_web; ?>" autocomplete="off" />
                                        </div>
                                    </div>
                                </div> -->
                            </div>
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        <button type="submit" class="btn green"><i class="fa fa-floppy-o"></i>
                                            Update</button>
                                    </div>
                                </div>
                            </div>
    ...
    $(document).ready(function() {
        ...
        $("#formInput").validate({
            ...
            messages: {
                ...
                //     url: 'Website tidak Valid (Ex. http://www.domain.com)'
                // }
            },
