...
<link href="<?= base_url(); ?>backend/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css"
                        ...
                        <form role="form" class="form-horizontal" method="post" id="formInput"
                            ...
                            <div class="form-body">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-icon right">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        placeholder="Enter Nama Makanan" name="nama" id="nama"
                                                        autocomplete="off" value="<?= $detail->menu_nama; ?>" autofocus>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-icon right">
                                                    ...
                                                    <select class="form-control" name="lstKategori">
                                                        ...
                                                        ?>
                                                        <option value="<?= $r->kategori_id; ?>" <?= $selected; ?>>
                                                            <?= $r->kategori_nama; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Stok Menu</label>
                                            <div class="col-md-5">
                                                <div class="input-icon right">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" class="form-control number" placeholder="0"
                                                        name="harga"
                                                        value="<?= number_format($detail->menu_harga, 0, '', ','); ?>"
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea class="form-control" rows="10"
                                                        name="deskripsi"><?= $detail->menu_deskripsi; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <img src="<?= base_url('img/menu_folder/thumbs/' . $detail->menu_foto); ?>"
                                                    width="50%">
                                                <?php } else { ?>
                            ...
                            <div class="form-actions" align="center">
                                ...
                                <a href="<?= site_url('admin/menu_makanan'); ?>" class="btn btn-warning"><i
...
<script type="text/javascript"
    src="<?= base_url(); ?>backend/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.js"></script>
<script type="text/javascript"
