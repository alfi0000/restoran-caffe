...
$(document).ready(function() {
    table = $('#tableData').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?= site_url('bar/monitoring/data_list') ?>",
            "type": "POST",
            "data": function(data) {
...
function konfirmData(order_id) {
    ...
    swal({
        ...
        if (!isConfirm) return;
        $.ajax({
            url: "<?= site_url('bar/order/confirmdata') ?>/" + id,
            type: "POST",
...
function hapusData(order_id) {
    ...
    swal({
        ...
        if (!isConfirm) return;
        $.ajax({
            url: "<?= site_url('bar/order/deletedata') ?>/" + id,
            type: "POST",
            success: function(data) {
                swal({
                    title: "Sukses",
...
function printNota(order_id) {
    var url = "<?= site_url('bar/order/cetaknotabayar/'); ?>" + order_id;
