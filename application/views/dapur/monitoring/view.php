...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('#tableData').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= site_url('dapur/monitoring/data_list') ?>",
                "type": "POST",
                "data": function(data) {
    ...
    function konfirmData(order_id) {
        ...
        swal({
            ...
            if (!isConfirm) return;
            $.ajax({
                url: "<?= site_url('dapur/order/confirmdata') ?>/" + id,
                type: "POST",
    ...
    function hapusData(order_id) {
        ...
        swal({
            ...
            if (!isConfirm) return;
            $.ajax({
                url: "<?= site_url('dapur/order/deletedata') ?>/" + id,
                type: "POST",
                success: function(data) {
                    swal({
                        title: "Sukses",
    ...
    function printNota(order_id) {
        var url = "<?= site_url('dapur/order/cetaknotabayar/'); ?>" + order_id;
